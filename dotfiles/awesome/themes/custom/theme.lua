...
function theme.at_screen_connect(s)
    ...
    s.mywibox:setup {
        ...
        { -- Right widgets
            ...
            arrow("#777E76", "#4B696D"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpu.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(4)), "#4B696D"),
            arrow("#4B696D", "#777E76"),
            wibox.container.background(wibox.container.margin(wibox.widget { net.widget, layout = wibox.layout.align.horizontal }, dpi(3), dpi(3)), "#777E76"),
            arrow("#777E76", "alpha"),
            s.mylayoutbox,
        },
    }
