{
  description = "Linode server kubernetes master configuration";
  ...
  outputs = { self, nixpkgs, ... }@inputs: {
    genNixOSConfigurations = parentInputs: {
      linode-kube-master = nixpkgs.lib.nixosSystem {
        system = "x86_64-linux";
              ...
              users.users = {
                ...
                mbund = {
                  ...
                  openssh.authorizedKeys.keys = [
                    "ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIPFjPOkSCUIWhRrIW5D94ZGr3DhGh2WYn1LAXctL2ChK mbund@mbund-desktop"
                  ];
                };
              };
